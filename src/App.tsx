  ...
  return (
    <div className="app">
      <div className="topbar">
        <h1>{tab === 'home' ? 'Today' : tab === 'history' ? 'History' : tab === 'charts' ? 'Charts' : 'Settings'}</h1>
      ...
      <nav className="nav">
        ...
        <button className={tab === 'charts' ? 'active' : ''} onClick={() => setTab('charts')}><span className="ico">📊</span>Charts</button>
